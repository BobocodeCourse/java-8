...
public class StreamTask_Reducing {
    public static void main(String[] args) {
        ...
        System.out.println("\n// 1 - Calculate sum of all account balances using reduce() method that receives two parameters: default value and lambda (DO NOT USE METHOD REFERENCE)");
        ...
        System.out.println("\n// 2 - Compute the amount of all stream elements using reduce methods that receives two parameters default value and lambda (DO NOT USE METHOD REFERENCE)");
